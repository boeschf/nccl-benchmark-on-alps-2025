...
#SBATCH --output=results_new_image_2/FI_CXI_RDZV_PROTO_alt_read_FI_CXI_RX_MATCH_MODE_hardware_launch_with_fixed_hsn_nccl-tests_nccl-2.26.2-1-aws-1.14.0-v0/run_0001/job-n-00512-N-0128-%j-logs/std.out
#SBATCH --error=results_new_image_2/FI_CXI_RDZV_PROTO_alt_read_FI_CXI_RX_MATCH_MODE_hardware_launch_with_fixed_hsn_nccl-tests_nccl-2.26.2-1-aws-1.14.0-v0/run_0001/job-n-00512-N-0128-%j-logs/std.err
...
OUT_DATA_DIR="results_new_image_2/FI_CXI_RDZV_PROTO_alt_read_FI_CXI_RX_MATCH_MODE_hardware_launch_with_fixed_hsn_nccl-tests_nccl-2.26.2-1-aws-1.14.0-v0/run_0001/job-n-00512-N-0128-${SLURM_JOB_ID}-logs"
