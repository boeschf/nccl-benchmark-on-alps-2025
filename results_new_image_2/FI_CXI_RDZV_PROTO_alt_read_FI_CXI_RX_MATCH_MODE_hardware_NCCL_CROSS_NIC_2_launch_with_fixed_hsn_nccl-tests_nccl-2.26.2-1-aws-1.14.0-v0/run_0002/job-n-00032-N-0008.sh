...
#SBATCH --output=results_new_image_2/FI_CXI_RDZV_PROTO_alt_read_FI_CXI_RX_MATCH_MODE_hardware_NCCL_CROSS_NIC_2_launch_with_fixed_hsn_nccl-tests_nccl-2.26.2-1-aws-1.14.0-v0/run_0002/job-n-00032-N-0008-%j-logs/std.out
#SBATCH --error=results_new_image_2/FI_CXI_RDZV_PROTO_alt_read_FI_CXI_RX_MATCH_MODE_hardware_NCCL_CROSS_NIC_2_launch_with_fixed_hsn_nccl-tests_nccl-2.26.2-1-aws-1.14.0-v0/run_0002/job-n-00032-N-0008-%j-logs/std.err
...
OUT_DATA_DIR="results_new_image_2/FI_CXI_RDZV_PROTO_alt_read_FI_CXI_RX_MATCH_MODE_hardware_NCCL_CROSS_NIC_2_launch_with_fixed_hsn_nccl-tests_nccl-2.26.2-1-aws-1.14.0-v0/run_0002/job-n-00032-N-0008-${SLURM_JOB_ID}-logs"
