...
#SBATCH --output=./results/FI_CXI_DEFAULT_CQ_SIZE_131072_FI_CXI_DEFAULT_TX_SIZE_32768_FI_CXI_SAFE_DEVMEM_COPY_THRESHOLD_16777216_NCCL_WORK_FIFO_DEPTH_4194304_nccl-tests_nccl-2.23.4-1-aws-1.9.2-v0/run_0000/job-n-00064-N-0016-%j.out
