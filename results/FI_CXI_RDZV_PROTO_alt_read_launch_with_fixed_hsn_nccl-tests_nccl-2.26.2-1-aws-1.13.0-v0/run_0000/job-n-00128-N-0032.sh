...
#SBATCH --output=results/FI_CXI_RDZV_PROTO_alt_read_launch_with_fixed_hsn_nccl-tests_nccl-2.26.2-1-aws-1.13.0-v0/run_0000/job-n-00128-N-0032-%j-logs/std.out
#SBATCH --error=results/FI_CXI_RDZV_PROTO_alt_read_launch_with_fixed_hsn_nccl-tests_nccl-2.26.2-1-aws-1.13.0-v0/run_0000/job-n-00128-N-0032-%j-logs/std.err
...
OUT_DATA_DIR="results/FI_CXI_RDZV_PROTO_alt_read_launch_with_fixed_hsn_nccl-tests_nccl-2.26.2-1-aws-1.13.0-v0/run_0000/job-n-00128-N-0032-${SLURM_JOB_ID}-logs"
